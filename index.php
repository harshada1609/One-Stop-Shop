	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">One Stop Shop</h1>
			</div>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Ashlesha Shete</h4>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Harshada Sarwade</h4>
									<h4 class="team-member-designation"></h4>
																	</div>
							</div>
							...
							<div class="panel-group" id="accordian">
								...
								<?php 
								  ...
								  $con=mysqli_connect('localhost','root');
									...
									mysqli_select_db($con,'v-learning');
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												One Stop Shop is an online E-learning website <br>
